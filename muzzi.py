#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To muzzamil Trickers
...
\033[1;94mmuzzi\033[1;91m: \033[1;91тЦТтЦУтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИ]99.9
...
jalan('\033[1;92m   ......................... MuzzamilTrickers.........................:')
...
CorrectUsername = "muzzi"
CorrectPassword = "muzzi"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:muzzi_hacker
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mB4Baloch\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By muzzi-hacker--тАвтЧИтАв---┬╗" #Dev:muzzi_hacker
...
: \033[1;93m.muzzihacker  muzzamiltrickers.... \033[1;93m :
тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд.' 
                whatsapp Num
               +923303262384"""
